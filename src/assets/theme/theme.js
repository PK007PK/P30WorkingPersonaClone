...
import paragraphValues from './paragraphValues';
import h1Values from './h1Values';
import h2Values from './h2Values';
import h3Values from './h3Values';
import leadValues from './leadValues';
import buttonValues from './buttonValues';
import naviValues from './naviValues';
